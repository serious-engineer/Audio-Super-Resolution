...
class MelSpectralConvergence(nn.Module):
    """
    Spectral convergence in mel-domain. This is similar to STFT-SC but applied directly on mel spectrograms.
    """
...
class MelLoss(nn.Module):
    """
    Combined Mel Loss:
    L = lambda1 * L1 + lambda2 * L2 + lambda3 * Mel-Spectral-Convergence
    """
